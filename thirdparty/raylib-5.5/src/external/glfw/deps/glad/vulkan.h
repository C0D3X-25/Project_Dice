...
typedef enum VkComponentSwizzle {
    VK_COMPONENT_SWIZZLE_IDcharacter = 0,
...
typedef enum VkSurfaceTransformFlagBitsKHR {
    VK_SURFACE_TRANSFORM_IDcharacter_BIT_KHR = 1,
...
typedef enum VkSamplerYcbcrModelConversion {
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_RGB_IDcharacter = 0,
    VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_IDcharacter = 1,
